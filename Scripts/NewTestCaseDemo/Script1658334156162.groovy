...
WebUI.rightClick(findTestObject('Object Repository/Page_CURA Healthcare Service/input_Demo account_form-control_1'))

WebUI.rightClick(findTestObject('Object Repository/Page_CURA Healthcare Service/input_Password_password'))
...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/input_Username_username'), 'John Deo')
...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'Daily Treatments')

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/div_Comment'))

WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'Treatments')
